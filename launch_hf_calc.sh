...
input_directory="/home/evanich/water_dimer_analysis/hf_inputs"
# Directory where the output files will be saved
output_directory="/home/evanich/water_dimer_analysis/hf_outputs"

# Create the output directory if it doesn't exist
mkdir -p "$output_directory"

# List all input files (for SAPT0)
input_files=$(find "$input_directory" -name "*6-31g.in")
